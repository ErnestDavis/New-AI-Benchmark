...
IMPORTANT: Use the file AIBenchmarkProblemsFinal.docx .  DO NOT use the file AIBlenchmarkOProblems.docx (without "Final").  The reason for this is explained below.
